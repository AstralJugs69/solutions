    ...
    <div style={{ backgroundColor: '#581c87', color: '#f3e8ff' }} className="py-12 md:py-20 showcase-portfolio-theme font-sans">
      <div className="container mx-auto px-4">
        ...
        <section id="pt-hero-variations" className="mb-16 md:mb-24">
          <h2 className="text-3xl md:text-4xl font-heading font-semibold mb-10 md:mb-12 text-center" style={{ color: '#c7d2fe' }}>
            Dynamic Hero Sections
          </h2>
          <div className="space-y-12 md:space-y-16">
            {/* Mockup 1: Full-Screen Image/Video */}
            <div>
              <h3 className="text-xl font-heading font-medium mb-4 text-center md:text-left" style={{color: '#e879f9'}}>Style 1: Immersive Visual Background</h3>
              <div
              ...
              >
                ...
                <div className="relative z-10">
                  <h4 className="text-3xl md:text-4xl font-heading font-bold mb-4" style={{color: '#f3e8ff'}}>Bold Visuals. Big Impact.</h4>
                  ...
                  <button type="button" className="font-heading font-semibold py-2.5 px-6 rounded-lg text-sm transition-opacity hover:opacity-90" style={{backgroundColor: '#e879f9', color: '#581c87'}}>
            ...
            <div>
              <h3 className="text-xl font-heading font-medium mb-4 text-center md:text-left" style={{color: '#e879f9'}}>Style 2: Animated Typography Focus</h3>
              <div
              ...
              >
                <div className="font-heading text-3xl md:text-5xl font-bold" style={{color: '#f3e8ff'}}>
                ...
                <button type="button" className="font-heading font-semibold py-2.5 px-6 rounded-lg text-sm border-2 transition-colors hover:bg-[#e879f9] hover:text-[#581c87]" style={{borderColor: '#e879f9', color: '#e879f9'}}>
        ...
        <section id="pt-project-layouts" className="mb-16 md:mb-24">
          ...
          <div className="space-y-10">
            {/* Masonry Grid */}
            <div>
              <h3 className="text-xl font-heading font-medium mb-4" style={{color: '#e879f9'}}>Masonry Grid Layout</h3>
            ...
            {/* Uniform Grid */}
            <div>
              <h3 className="text-xl font-heading font-medium mb-4" style={{color: '#e879f9'}}>Uniform Grid Layout</h3>
            ...
            {/* List View */}
            <div>
              <h3 className="text-xl font-heading font-medium mb-4" style={{color: '#e879f9'}}>List View Layout</h3>
        ...
        <section id="pt-about-services" className="mb-16 md:mb-24">
          ...
          <div className="p-6 md:p-8 rounded-lg shadow-xl" style={{backgroundColor: '#86198f' /* secondary showcase color */}}>
            <h3 className="text-2xl font-heading font-medium mb-6 text-center md:text-left" style={{color: '#e879f9'}}>About Me Page Layout</h3>
            <div className="flex flex-col md:flex-row gap-8 items-center" style={{color: '#f3e8ff'}}>
              ...
              <div className="w-full md:w-1/3 flex flex-col items-center">
                ...
                <h4 className="font-heading text-xl font-semibold" style={{color: '#f3e8ff'}}>[Your Name]</h4>
                <p className="text-sm opacity-80">[Your Title / Tagline]</p>
              </div>
              {/* Right Column: Bio, Skills, Testimonials */}
              <div className="w-full md:w-2/3 space-y-6">
                <div>
                  <h5 className="font-heading text-lg font-semibold mb-2" style={{color: '#c7d2fe'}}>About Me</h5>
                ...
                <div>
                  <h5 className="font-heading text-lg font-semibold mb-2" style={{color: '#c7d2fe'}}>Skills</h5>
                ...
                <div>
                  <h5 className="font-heading text-lg font-semibold mb-2" style={{color: '#c7d2fe'}}>Testimonials (Snippet)</h5>
        ...
        <section id="pt-contact-footer" className="mb-16 md:mb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div className="p-6 md:p-8 rounded-lg shadow-xl" style={{backgroundColor: '#86198f'}}>
              <h3 className="text-2xl font-heading font-medium mb-6 text-center md:text-left" style={{color: '#e879f9'}}>Minimal Contact Form</h3>
              <form className="space-y-4">
                ...
                <button type="button" className="w-full font-heading font-semibold py-2.5 px-5 rounded-md text-sm transition-opacity hover:opacity-90" style={{backgroundColor: '#e879f9', color: '#581c87'}}>
                  Send Message
                </button>
              </form>
            </div>
            ...
            <div className="space-y-8">
              <div className="p-6 md:p-8 rounded-lg shadow-xl" style={{backgroundColor: '#86198f'}}>
                <h3 className="text-2xl font-heading font-medium mb-6 text-center md:text-left" style={{color: '#e879f9'}}>Simple Footer</h3>
          ...
          <div className="p-6 md:p-8 rounded-lg shadow-xl" style={{backgroundColor: '#86198f' /* secondary showcase color */}}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-heading font-semibold mb-3" style={{color: '#e879f9'}}>Color Palette</h4>
                ...
                <div>
                  <h4 className="text-lg font-heading font-semibold mb-3" style={{color: '#e879f9'}}>Typography</h4>
                  <div className="space-y-3">
                    {[
                ...
                <div>
                  <h4 className="text-lg font-heading font-semibold mb-3" style={{color: '#e879f9'}}>Layout Options</h4>
                  <div className="space-y-3">
                    {[
              ...
              <div className="h-full min-h-[250px] md:min-h-[350px] flex flex-col items-center justify-center p-6 rounded-lg" style={{backgroundColor: 'rgba(0,0,0,0.2)'}}>
                ...
                <p className="font-heading text-lg font-semibold mb-2" style={{color: '#c7d2fe'}}>Live Preview (Conceptual)</p>
